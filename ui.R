...
shinyUI(
  fluidPage(
    ...
    titlePanel(title = "Trends in Demographics and Income Dashboard Using Shiny"),
      ...
      column(3, 
             wellPanel(
               ...
               radioButtons("categorical_variable",
                   ...
                   checkboxInput("if_stacked", "stack bars", value= FALSE )     # add check box input for stacked bar chart option
               )
             ),
